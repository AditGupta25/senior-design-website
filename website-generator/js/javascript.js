...
function validateInputs(){
    ...
    var selectedValue = document.getElementById("projectType").value;
    globalInformation.projectCategory = selectedValue;
